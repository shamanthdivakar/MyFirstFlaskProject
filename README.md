...
- 🎯 Entry points to execute your program using `python -m <myfirstflaskproject>` or `$ myfirstflaskproject` with basic CLI argument parsing.
...
---
# myfirstflaskproject Flask Application

Awesome myfirstflaskproject created by shamanthdivakar
...
```bash
git clone https://github.com/shamanthdivakar/MyFirstFlaskProject myfirstflaskproject
cd myfirstflaskproject
make install
```
...
```bash
pip install myfirstflaskproject
```
...
```bash
myfirstflaskproject create-db   # run once
myfirstflaskproject populate-db  # run once (optional)
myfirstflaskproject add-user -u admin -p 1234  # ads a user
myfirstflaskproject run
```
